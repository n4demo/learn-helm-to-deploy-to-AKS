...
## Congratulations!! You now know how to deploy multiple instances and different versions of an nginx application across different Kubernetes namespaces/environments. 